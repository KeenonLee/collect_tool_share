...
def ginkgo_google_report():
    url = 'https://mastern-jenkins-csb-openshift-qe.apps.ocp-c1.prod.psi.redhat.com/job/ocp-common/job/' + Jobname + '/' + run_id
    ...
    if xml_filename != "":
        ...
        xmlurl = 'https://mastern-jenkins-csb-openshift-qe.apps.ocp-c1.prod.psi.redhat.com/job/ocp-common/job/' + Jobname + '/' + run_id + '/artifact/private/' + xml_filename
        console_url = 'https://mastern-jenkins-csb-openshift-qe.apps.ocp-c1.prod.psi.redhat.com/job/ocp-common/job/' + Jobname + '/' + run_id + '/consoleFull'
        ...
        with open("console.html", "wb") as code:
            ...
            sheet_name = Config[Jobname]['sheets'][-8]
                    ...
                    try:
                        if testcase[0].text != "":
                            ...
                            if testcase_info_dict['name']:
                                ...
                                #if department == 'OLM':
                                #if department == 'OLM' or department == 'Operator_SDK' or department == 'Image_Registry' or department == 'MCO':
                                if department == 'Image_Registry':
...
def write_google_sheet(result_list, sheet_name):
    ...
    worksheet.update_acell('F2',f'=HYPERLINK(CONCATENATE("https://mastern-jenkins-csb-openshift-qe.apps.ocp-c1.prod.psi.redhat.com/job/ocp-common/job/","{Jobname}","/",{run_id},"/testReport/"),"{jenkins_num}")')
...
###   Set the parameters
    ...
    parser.add_argument('-r', '--runid', type=str, required=True, help="RUN id")
